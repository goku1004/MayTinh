package com.example.goku.calculator;
...
public class FragmentActivity extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.button_Add:
                edtText.append(ADD);
                setEventCLickCalculator(ADD);
                break;
            case R.id.button_Sub:
                edtText.append(SUB);
               setEventCLickCalculator(SUB);
                break;
            case R.id.button_Mul:
                edtText.append(MUL);
                setEventCLickCalculator(MUL);
                break;
            case R.id.button_Div:
                edtText.append(DIV);
                setEventCLickCalculator(DIV);
                break;
            case R.id.button_Ac:
    ...
    public void setEventCLickCalculator(String calculator){
        if (!tvResult.getText().toString().isEmpty()){
            result=Double.parseDouble(tvResult.getText().toString());
            edtText.setText(tvResult.getText().toString()+calculator);
        }
    }

    public void algorithmCalculator(){
